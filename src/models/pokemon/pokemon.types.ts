/*
    Copied from this url to save time creating the types
    https://github.com/PokeAPI/pokedex-promise-v2/blob/master/types/index.d.ts

    This library is the recommended one for node js, but for typescript purposes is ok to use the types from the url above
*/
